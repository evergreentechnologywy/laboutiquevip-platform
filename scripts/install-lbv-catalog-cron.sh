...
CRON_MERGE="0 0 * * * TZ=America/Denver REPO_DIR=$REPO IMPORT_FLAG_PATH=/var/run/lboutiquevip/import-in-progress $CAPS $REPO/scripts/run-us-verified-catalog-merge.sh >> /var/log/laboutiquevip/cron.log 2>&1 # lbv-us-verified-merge-midnight"
