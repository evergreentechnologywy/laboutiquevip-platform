...
CRON_MIDNIGHT="0 5 * * * REPO_DIR=$REPO IMPORT_FLAG_PATH=/var/run/lboutiquevip/import-in-progress $CAPS $REPO/scripts/import-orchestrator.sh >> /var/log/laboutiquevip/cron.log 2>&1 # import-orchestrator-midnight"
