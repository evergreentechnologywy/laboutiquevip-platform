...
- Added Confirmo webhook scaffold:
...
## Remaining
- Replace placeholder provider contracts with real Confirmo/Didit API field mappings.
...
## Blockers
- Missing Confirmo credentials and canonical webhook payload samples.
